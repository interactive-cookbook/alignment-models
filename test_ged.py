"""
Testing functions for the Alignment Model in the GED (Graph Edit Distance)-case.
    ...
    def run_folds_test(
        ...
        for fold in range(num_folds):
            ...
            if test_dish_id == -1:
                ...
                test_dish_id = len(dish_list_test) - 1 # TODO: why? shouldn't it be 0, if anything? or maybe just move the line ```test_dish_id -= 1``` to the end of the loop?
